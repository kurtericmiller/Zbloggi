...
class Form_Contact extends Zend_Form
{
    public function init()
    {
        ...
        $this->addElement('button', 'ContactSubmit', array('type' => 'submit', 'label' => 'Send', 'class' => 'button', 'decorators' => array('ViewHelper',),));
        $this->addDisplayGroup(array('ContactSubmit'), 'submitButtons', array('order' => 3, 'decorators' => array('FormElements', array('HtmlTag', array('tag' => 'div', 'class' => 'element')),),));
    }
}
