...
class Blog_CommentController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->view->headScript()->appendScript("SyntaxHighlighter.defaults['toolbar'] = false;SyntaxHighlighter.vars.discoveredBrushes=null; SyntaxHighlighter.all();", 'text/javascript');
