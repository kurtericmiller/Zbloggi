...
class Rss_IndexController extends Zend_Rest_Controller
{
  ...
  public function indexAction()
  {
    ...
    // set entry elements
    foreach ($ac as $a) {
      $output['entries'][] = array('title' => $a->get('article_title'), 'link' => $this->_apiBaseUrl . '/comment?id=' . $a->get('id'), 'description' => 'This is an article.', 'content' => $a->get('article_text'), 'created' => strtotime($a->get('created_at')), 'updated' => strtotime($a->get('updated_at')));
    }
