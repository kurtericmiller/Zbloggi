<?php
/**
 * Deferred Testmodel Collection object definition
 * @package Mapper
 */
/**
 * DeferredTestmodelCollection class
 * Optimized (cached) object activity
 */
class Local_Domain_Mappers_DeferredTestmodelCollection extends Local_Domain_Mappers_TestmodelCollection
{
