...
class Local_Domain_Mappers_MenuMapper extends Local_Domain_Mapper implements MenuFinder
{
  ...
  {
    $values = array($obj->get('menu'), $obj->get('title'), $obj->get('link'), $obj->get('ordering'), $obj->get('created_at'), $obj->get('updated_at'));
  ...
  {
    $values = array($obj->get('menu'), $obj->get('title'), $obj->get('link'), $obj->get('ordering'), $obj->get('created_at'), $obj->get('updated_at'), $obj->getId());
