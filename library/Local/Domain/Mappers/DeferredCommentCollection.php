<?php
/**
 * Deferred Comment Collection object definition
 * @package Mapper
 */
/**
 * DeferredCommentCollection class
 * Optimized (cached) object activity
 */
class Local_Domain_Mappers_DeferredCommentCollection extends Local_Domain_Mappers_CommentCollection
{
