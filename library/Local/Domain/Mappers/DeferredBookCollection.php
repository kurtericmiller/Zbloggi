<?php
/**
 * Deferred Book Collection object definition
 * @package Mapper
 */
/**
 * DeferredBookCollection class
 * Optimized (cached) object activity
 */
class Local_Domain_Mappers_DeferredBookCollection extends Local_Domain_Mappers_BookCollection
{
