...
class Local_Domain_Mappers_UserMapper extends Local_Domain_Mapper implements UserFinder
{
    ...
    {
        $values = array($obj->get('username'), $obj->get('email'), $obj->get('role'), $obj->get('password'), $obj->get('created_at'), $obj->get('updated_at'));
    ...
    {
        $values = array($obj->get('username'), $obj->get('email'), $obj->get('role'), $obj->get('password'), $obj->get('created_at'), $obj->get('updated_at'), $obj->getId());
