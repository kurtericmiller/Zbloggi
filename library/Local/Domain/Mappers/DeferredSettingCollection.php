<?php
/**
 * Deferred Setting Collection object definition
 * @package Mapper
 */
/**
 * DeferredSettingCollection class
 * Optimized (cached) object activity
 */
class Local_Domain_Mappers_DeferredSettingCollection extends Local_Domain_Mappers_SettingCollection
{
