...
class Local_Domain_Mappers_SettingMapper extends Local_Domain_Mapper implements SettingFinder
{
    ...
    function __construct()
    {
        ...
        $this->updateStmt = 'UPDATE settings SET site_title=?,site_tagline=?,site_url=?,headlineId=?,articleCount=?,bookCount=?,latestArticleCount=?,amazonLU=?,admArtCnt=?,admComCnt=?,admUserCnt=?,defemail=?,created_at=?,updated_at=? WHERE id=?';
        $this->insertStmt = 'INSERT into settings (site_title,site_tagline,site_url,headlineId,articleCount,bookCount,latestArticleCount,amazonLU,admArtCnt,admComCnt,admUserCnt,defemail,created_at,updated_at) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
    ...
    {
        $values = array($obj->get('site_title'), $obj->get('site_tagline'), $obj->get('site_url'), $obj->get('headlineId'), $obj->get('articleCount'), $obj->get('bookCount'), $obj->get('latestArticleCount'), $obj->get('amazonLU'), $obj->get('admArtCnt'), $obj->get('admComCnt'), $obj->get('admUserCnt'), $obj->get('defemail'), $obj->get('created_at'), $obj->get('updated_at'));
    ...
    {
        $values = array($obj->get('site_title'), $obj->get('site_tagline'), $obj->get('site_url'), $obj->get('headlineId'), $obj->get('articleCount'), $obj->get('bookCount'), $obj->get('latestArticleCount'), $obj->get('amazonLU'), $obj->get('admArtCnt'), $obj->get('admComCnt'), $obj->get('admUserCnt'), $obj->get('defemail'), $obj->get('created_at'), $obj->get('updated_at'), $obj->getId());
