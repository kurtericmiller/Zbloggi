<?php
/**
 * Deferred Profile Collection object definition
 * @package Mapper
 */
/**
 * DeferredProfileCollection class
 * Optimized (cached) object activity
 */
class Local_Domain_Mappers_DeferredProfileCollection extends Local_Domain_Mappers_ProfileCollection
{
