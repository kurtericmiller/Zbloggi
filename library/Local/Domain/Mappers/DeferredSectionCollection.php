<?php
/**
 * Deferred Section Collection object definition
 * @package Mapper
 */
/**
 * DeferredSectionCollection class
 * Optimized (cached) object activity
 */
class Local_Domain_Mappers_DeferredSectionCollection extends Local_Domain_Mappers_SectionCollection
{
