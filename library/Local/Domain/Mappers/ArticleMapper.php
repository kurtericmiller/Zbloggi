...
class Local_Domain_Mappers_ArticleMapper extends Local_Domain_Mapper implements ArticleFinder
{
  ...
  {
    $values = array($obj->get('user_id'), $obj->get('published'), $obj->get('read_count'), $obj->get('article_title'), $obj->get('article_text'), $obj->get('created_at'), $obj->get('updated_at'));
  ...
  {
    $values = array($obj->get('user_id'), $obj->get('published'), $obj->get('read_count'), $obj->get('article_title'), $obj->get('article_text'), $obj->get('created_at'), $obj->get('updated_at'), $obj->getId());
