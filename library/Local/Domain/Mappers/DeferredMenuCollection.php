<?php
/**
 * Deferred Menu Collection object definition
 * @package Mapper
 */
/**
 * DeferredMenuCollection class
 * Optimized (cached) object activity
 */
class Local_Domain_Mappers_DeferredMenuCollection extends Local_Domain_Mappers_MenuCollection
{
