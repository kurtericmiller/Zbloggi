<?php
/**
 * Deferred Article Collection object definition
 * @package Mapper
 */
/**
 * DeferredArticleCollection class
 * Optimized (cached) object activity
 */
class Local_Domain_Mappers_DeferredArticleCollection extends Local_Domain_Mappers_ArticleCollection
{
