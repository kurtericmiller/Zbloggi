<?php
/**
 * Deferred User Collection object definition
 * @package Mapper
 */
/**
 * DeferredUserCollection class
 * Optimized (cached) object activity
 */
class Local_Domain_Mappers_DeferredUserCollection extends Local_Domain_Mappers_UserCollection
{
