 ...
 */
class Local_Domain_Models_Book extends Local_Domain_DomainObject
{
  private $_id;
  private $_title;
  private $_author;
  ...
  private $_created_at;
  private $_updated_at;
  function __construct($id = null, $title = null, $author = null, $image = null, $link = null, $created_at = null, $updated_at = null)
  {
    parent::__construct($id);
    $defaults = $this->getDefaults();
    $this->_title = is_null($title) ? $defaults['_title'] : $title;
    $this->_author = is_null($author) ? $defaults['_author'] : $author;
    $this->_image = is_null($image) ? $defaults['_image'] : $image;
