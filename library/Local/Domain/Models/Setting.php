...
class Local_Domain_Models_Setting extends Local_Domain_DomainObject {
  ...
  function __construct (
    ...
    $site_url = null,
    $headlineId = null,
    $homeArticleCount = null,
    $articleCount = null,
    $bookCount = null,
    $latestArticleCount = null,
    $amazonLU = null,
    $admArtCnt = null,
    $admComCnt = null,
    $admUserCnt = null,
    ...
    $updated_at = null
      ...
      $this->_homeArticleCount = is_null($homeArticleCount) ? $defaults['_homeArticleCount'] : $homeArticleCount;
